...
public class GridMode
{
    ...
    protected int getGridSnap(int i)
    {
        if (i < 0)
        {
            return ((i - GametableCanvas.BASE_SQUARE_SIZE / 2) / GametableCanvas.BASE_SQUARE_SIZE) * GametableCanvas.BASE_SQUARE_SIZE;
        }
        return ((i + GametableCanvas.BASE_SQUARE_SIZE / 2) / GametableCanvas.BASE_SQUARE_SIZE) * GametableCanvas.BASE_SQUARE_SIZE;
    }
    ...
    {
        Point snappedPoint = snapPointEx(new Point(pog.getX(), pog.getY()), true, GametableCanvas.BASE_SQUARE_SIZE * pog.getFaceSize());
