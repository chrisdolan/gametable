...
public class HexGridMode extends GridMode
{
    ...
    public Point snapPointEx(Point modelPointIn, boolean bSnapForPog, int pogSize)
    {
        ...
        int gridX = x / GametableCanvas.BASE_SQUARE_SIZE;
        ...
        if (bSnapForPog)
        {
            ...
            int face = pogSize / GametableCanvas.BASE_SQUARE_SIZE;
            if (face % 2 == 1)
            {
                // odd faces snap to centers
                Point candidates[] = new Point[3];

                Point point1 = new Point(x + GametableCanvas.BASE_SQUARE_SIZE - m_hexImageOffsets[0], y); // Our
                // hex's
                // point
                // 1,
                // for
                ...
                // neighbor's
                // center
                candidates[2] = new Point(candidates[0].x - GametableCanvas.BASE_SQUARE_SIZE, candidates[0].y - GametableCanvas.BASE_SQUARE_SIZE
        ...
        else
        {
            ...
            // neighbor's
            // center
            candidates[6] = new Point(candidates[4].x - GametableCanvas.BASE_SQUARE_SIZE, candidates[4].y - GametableCanvas.BASE_SQUARE_SIZE / 2); // Our
            // upstairs
            // neighbor's
            // center
    ...
    public void drawLines(Graphics g, int topLeftX, int topLeftY, int width, int height)
    {
        ...
        // draw a hex grid
        Image toTile = m_hexImages[m_canvas.m_zoom];
        ...
        int offsetX = -m_hexImageOffsets[m_canvas.m_zoom] / 2;
    ...
    // data
    private Image[]             m_hexImages           = new Image[GametableCanvas.NUM_ZOOM_LEVELS];  // one hex
    private int[]               m_hexImageOffsets     = new int[GametableCanvas.NUM_ZOOM_LEVELS];    // how far
}
